...
/// <summary>
///   Used when the statuses in an actors StatusManager change in any way.
/// </summary>
/// <returns>
///   The StatusManagers actor <paramref name="address"/>, <para />
///   the <paramref name="statusId"/> that made the change, <para />
///   and what the <paramref name="changeType"/> was.
/// </returns>
...
/// <summary>
///   Used when an applied status meets its chain trigger condition, causing a chained action to occur.
/// </summary>
/// <returns>
///   The Actor <paramref name="address"/> of the StatusManager this occured in, <para />
///   the <paramref name="statusId"/> that the chain trigger occured in, <para />
///   the <paramref name="condition"/> that invoked the chain, <para />
///   the <paramref name="chainType"/> indicating the module being chained, <para />
///   and the <paramref name="chainedId"/> from the chainTypes module.
/// </returns>
...
/// <summary>
///   Used when a preset is edited in any way.
/// </summary>
...
/// <summary>
///   Used when a loci event is edited in any way.
/// </summary>
